            ...
            <div className="flex flex-col gap-6 bg-white  p-6 ">
              ...
              <div>
                <p className="text-gray-700 leading-relaxed">
                  ...
                  including food, water, medicine, and temporary shelter, while
                  working on rebuilding efforts in the long term.
                </p>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-xl p-6 space-y-6">
              ...
              <section className="p-5 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <p className="text-sm text-gray-700 mb-5">
                  Every contribution directly impacts families rebuilding their
              ...
              {/* Volunteer Section */}
              <section className="p-5 bg-amber-50 rounded-lg border border-amber-100 pointer-events-none">
                <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    variant="outlined"
                    size="medium"
                    className="font-bold normal-case rounded-lg border-amber-300 hover:border-amber-400 hover:bg-amber-50 text-amber-700 transition-colors"
                  >
                    Remote Support
                  </Button>
                </div>
