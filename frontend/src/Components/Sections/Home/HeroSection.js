import image from "../../../Assets/Images/home/earthquake.webp";
  ...
  return (
    ...
    >
      ...
      <div className="h-full hidden lg:flex flex-col justify-center relative">
        ...
        <div className="w-[2px] h-2/5 bg-blue-700 absolute right-0 bottom-0"></div>
              ...
              <div className="justify-center flex items-center">
                <div className="relative">
                  <div className="absolute inset-0 flex justify-center items-center">
                    ...
                    <div className="border border-white w-8 h-8 rounded-full absolute"></div>
                    <div className="bg-white z-10 w-5 h-5 rounded-full absolute"></div>
                    {/* <div className="w-[1px] z-20 sm:h-24 md:h-48 lg:h-screen top-0 bg-white absolute"></div> */}
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center space-x-6">
            ...
            <div className="relative">
              <div className="absolute inset-0 flex justify-center items-center">
                <div className="border border-white w-8 h-8 rounded-full absolute"></div>
                <div className="bg-white z-10 w-5 h-5 rounded-full absolute"></div>
                {/* <div className="w-[1px] sm:h-24 md:h-36 lg:h-48 bg-white absolute "></div> */}
              </div>
            </div>
          </div>
        </div>
