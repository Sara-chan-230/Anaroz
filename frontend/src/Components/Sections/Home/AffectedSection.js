...
const AffectedSection = () => {
  return (
    <div className="w-full flex  items-center flex-wrap justify-center md:gap-0 gap-14 md:justify-start">
      ...
      <div className="md:w-[35%] w-[90%] gap-5 items-start flex flex-col justify-between">
